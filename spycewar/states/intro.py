...
class Intro(State):
    ...
    def __init__(self) -> None:
        """Initialise the introduction state, setting up the text to be displayed and the next state."""
        super().__init__()
    ...
    def enter(self, context: GameContext) -> None:
        """Ensure the state is not done when entering the introduction state."""
    ...
    def __load_and_play_game_music(self) -> None:
        """Load and plays the game music for the introduction state."""
    ...
    def exit(self) -> GameContext:
        """Exit the introduction state, currently doing nothing."""
        return self.context
    ...
    def process_events(self, event: pygame.event.Event) -> None:
        """Process events in the introduction state, currently doing nothing."""

    def update(self, delta_time: float) -> None:
        """Update the introduction state, currently doing nothing."""

    def render(self, surface_dst: pygame.Surface) -> None:
        """Render the introduction text to the given surface.
    ...
    def release(self) -> None:
        """Release resources used by the introduction state, currently doing nothing."""

    def __render_subtext(self) -> None:
        """Render the subtitle text to be displayed on the introduction screen."""
    ...
    def __render_game_title(self) -> None:
        """Render the game title text to be displayed on the introduction screen."""
